...
$title = Lang::get('register_title'); 
?>

<div class="max-w-md mx-auto bg-white rounded-lg shadow-md p-6">
    <h1 class="text-2xl font-bold text-center mb-6"><?= Lang::get('register_title') ?></h1>
    <?php if (!empty($error)): ?>
    ...
    <form method="POST" action="/IBIF/public/register" class="space-y-4">
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700"><?= Lang::get('confirm_password_label') ?></label>
    ...
    <div class="text-center mt-4">
        <p class="text-sm text-gray-600">
            <?= Lang::get('already_have_account') ?>
            <a href="/IBIF/public/login" class="text-blue-600 hover:text-blue-500"><?= Lang::get('login') ?></a>
        </p>
    </div>
</div>